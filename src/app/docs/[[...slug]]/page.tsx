...
// Propcore star icon for headers
function HeaderStar({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className || "size-6 text-main"}>
          ...
          <article>
            <div className="mb-8">
              <h1 className="flex items-center gap-3">
                <HeaderStar className="size-8 text-main" />
                {title}
                <HeaderStar className="size-8 text-main" />
              </h1>
              {description && (
                <p className="mt-0 mb-4 not-prose sm:text-lg text-base font-base text-foreground uppercase tracking-wider">
                  {description}
                </p>
              )}
              {shadcnDocsLink && (
