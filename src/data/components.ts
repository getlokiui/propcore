...
import ButtonRotatedDemo from "@/examples/ui/button/rotated"
import ButtonArrowsDemo from "@/examples/ui/button/arrows"
...
import CardDefaultDemo from "@/examples/ui/card/index"
import CardWithTextureDemo from "@/examples/ui/card/with-texture"
import CardWithBarDemo from "@/examples/ui/card/with-bar"
import CardWithBadgeDemo from "@/examples/ui/card/with-badge"
import CardWithAccentStripeDemo from "@/examples/ui/card/with-accent-stripe"
import CardWithDividerDemo from "@/examples/ui/card/with-divider"
import CardStampDemo from "@/examples/ui/card/stamped"
import CardRotatedDemo from "@/examples/ui/card/rotated"
import CardFullPropagandaDemo from "@/examples/ui/card/full-propaganda"
...
import CheckboxAggressiveDemo from "@/examples/ui/checkbox/aggressive"
...
import HeroCardDemo from "@/examples/ui/hero-card"
import HoverCardDemo from "@/examples/ui/hover-card"
import IdBadgeDemo from "@/examples/ui/id-badge"
...
import InputAggressiveDemo from "@/examples/ui/input/aggressive"
...
import ProgressAggressiveDemo from "@/examples/ui/progress/aggressive"
import RadioGroupDemo from "@/examples/ui/radio-group"
import RadioGroupAggressiveDemo from "@/examples/ui/radio-group/aggressive"
...
import SliderAggressiveDemo from "@/examples/ui/slider/aggressive"
...
import StepperDemo from "@/examples/ui/stepper"
import SectionBannerDemo from "@/examples/ui/section-banner"
import ShapesDemo from "@/examples/ui/shapes"
import SwitchDemo from "@/examples/ui/switch"
import TableDemo from "@/examples/ui/table"
import TabsDemo from "@/examples/ui/tabs"
import TabsAggressiveDemo from "@/examples/ui/tabs/aggressive"
import TextareaDemo from "@/examples/ui/textarea"
import TextareaAggressiveDemo from "@/examples/ui/textarea/aggressive"
import TooltipDemo from "@/examples/ui/tooltip"
import TooltipAggressiveDemo from "@/examples/ui/tooltip/aggressive"
...
const COMPONENTS: Component[] = [
  ...
  },
  {
    ...
    examples: {
      ...
      icon: ButtonIconDemo,
      rotated: ButtonRotatedDemo,
      arrows: ButtonArrowsDemo,
    },
  },
  {
    name: "Calendar",
  ...
  },
  {
    ...
    examples: {
      default: CardDefaultDemo,
      "with-texture": CardWithTextureDemo,
      "with-bar": CardWithBarDemo,
      "with-badge": CardWithBadgeDemo,
      "with-accent-stripe": CardWithAccentStripeDemo,
      "with-divider": CardWithDividerDemo,
      stamped: CardStampDemo,
      rotated: CardRotatedDemo,
      "full-propaganda": CardFullPropagandaDemo,
    },
  },
  {
    name: "Carousel",
  ...
  },
  {
    ...
    examples: {
      ...
      aggressive: CheckboxAggressiveDemo,
    },
  },
  {
    name: "Collapsible",
  ...
  },
  {
    ...
    examples: {
      ...
      aggressive: InputAggressiveDemo,
    },
  },
  {
    name: "Label",
  ...
  },
  {
    ...
    examples: {
      ...
      aggressive: ProgressAggressiveDemo,
    },
  },
  {
    name: "Radio Group",
    ...
    examples: {
      ...
      aggressive: RadioGroupAggressiveDemo,
    },
  },
  {
    name: "Resizable",
  ...
  },
  {
    ...
    examples: {
      ...
      aggressive: SliderAggressiveDemo,
    },
  },
  {
    name: "Sonner",
  ...
  },
  {
    ...
    examples: {
      ...
      aggressive: TextareaAggressiveDemo,
    },
  },
  {
    name: "Tooltip",
    ...
    examples: {
      default: TooltipDemo,
      aggressive: TooltipAggressiveDemo,
    },
  },
  {
    name: "Hero Card",
    exampleComponent: HeroCardDemo,
  },
  {
    name: "ID Badge",
    exampleComponent: IdBadgeDemo,
  },
  {
    name: "Stepper",
    exampleComponent: StepperDemo,
  },
  {
    name: "Section Banner",
    exampleComponent: SectionBannerDemo,
    notShadcn: true,
  },
  {
    name: "Shapes",
    exampleComponent: ShapesDemo,
    notShadcn: true,
  },
]
