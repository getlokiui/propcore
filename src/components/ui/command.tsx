...
function CommandInput({
  ...
  return (
    <div
      ...
      className="flex h-12 gap-3 items-center border-b-3 border-border px-4 bg-main text-main-foreground"
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          ...
          "outline-hidden",
          "placeholder:text-main-foreground/60 placeholder:normal-case placeholder:tracking-normal placeholder:font-base",
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        ...
        "[&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-heading",
        "[&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-wider",
        "[&_[cmdk-group-heading]]:text-foreground/60",
        className,
      )}
      {...props}
    />
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-xs font-heading tracking-widest",
        "px-1.5 py-0.5 rounded-base",
        "bg-border/20 text-foreground/60",
        className,
      )}
      {...props}
    />
