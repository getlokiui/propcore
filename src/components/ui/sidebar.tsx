...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden outline-2 outline-transparent rounded-base p-2 text-left text-sm ring-ring transition-all duration-200 hover:bg-foreground/10 hover:text-main focus-visible:outline-border focus-visible:text-main disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      size: {
        default: "h-8 text-sm",
      ...
      variant: {
        default: "data-[active=true]:bg-main data-[active=true]:text-main-foreground data-[active=true]:outline-border",
        aggressive: [
          "data-[active=true]:bg-border data-[active=true]:text-background",
          "data-[active=true]:translate-x-2 data-[active=true]:-rotate-1",
          "data-[active=true]:shadow-[4px_4px_0_var(--main)]",
          "data-[active=true]:border-l-4 data-[active=true]:border-l-main",
          "data-[active=true]:font-heading data-[active=true]:uppercase data-[active=true]:tracking-wider",
        ],
      },
    },
    defaultVariants: {
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "[&_svg]:text-foreground hover:[&_svg]:text-main text-foreground hover:bg-foreground/10 outline-transparent outline-2 absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-base p-0 transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        // Increases the hit area of the button on mobile.
        "after:absolute after:-inset-2 md:after:hidden",
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-foreground hover:bg-foreground/10 hover:text-main outline-transparent outline-2 [&>svg]:text-foreground hover:[&>svg]:text-main flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-base px-2 transition-all duration-200 focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
        variant === "default" && "data-[active=true]:bg-main data-[active=true]:text-main-foreground data-[active=true]:outline-border data-[active=true]:[&>svg]:text-main-foreground",
        variant === "aggressive" && [
          "data-[active=true]:bg-border data-[active=true]:text-background",
          "data-[active=true]:translate-x-1 data-[active=true]:-rotate-1",
          "data-[active=true]:shadow-[3px_3px_0_var(--main)]",
          "data-[active=true]:border-l-2 data-[active=true]:border-l-main",
        ],
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
