...
// Propcore star icon for section headers
function SectionStar({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className || "size-5 text-main mr-2 inline-block"}>
...
export const sharedComponents = {
  ...
  TableHeader,
  TableRow,
  // Custom h2 with star prefix
  h2: ({ children, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h2 {...props}>
      <SectionStar className="size-5 text-main mr-2 inline-block align-middle -mt-1" />
      {children}
    </h2>
  ),
}
