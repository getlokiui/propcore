---
title: Installation
description: Learn how to install Propcore components.
---
...
<Warning className="mt-8 mb-4" description="Propcore uses CSS variables for styling. It doesn't matter which baseColor you choose during init, because Propcore styling will override it." />
...
After you're done you'll come back to the Propcore button page, and copy the button component to your project inside `components/ui/button.tsx`
(this is the default component path) or your custom component path.

Keep in mind that Propcore components can have different variants than default shadcn components.
