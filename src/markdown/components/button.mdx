...
<ComponentPreview component="button" example="rotated">
  ```tsx file=<rootDir>/src/examples/ui/button/rotated.tsx
  ```
</ComponentPreview>
...
<ComponentPreview component="button" example="arrows">
  ```tsx file=<rootDir>/src/examples/ui/button/arrows.tsx
  ```
</ComponentPreview>